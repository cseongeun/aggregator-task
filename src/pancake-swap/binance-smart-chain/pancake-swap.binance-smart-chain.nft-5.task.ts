...
@Injectable()
export class PancakeSwapBinanceSmartChainNFT_5_Task extends NFTTaskTemplate {
  constructor(
    ...
    super(
      TASK_ID.PANCAKE_SWAP_BINANCE_SMART_CHAIN_NFT_5,
      handlerService,
      nfTokenService,
      context,
    );
  ...
  getNFTokenDetail(): { name: string; address: string } {
    const target = this.context.nfToken5;
