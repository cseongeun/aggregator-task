...
@Injectable()
export class PancakeSwapBinanceSmartChainNFT_4_Task extends NFTTaskTemplate {
  constructor(
    ...
    super(
      TASK_ID.PANCAKE_SWAP_BINANCE_SMART_CHAIN_NFT_4,
      taskHandlerService,
      nfTokenService,
      context,
    );
  ...
  getNFTokenDetail(): { name: string; address: string } {
    const target = this.context.nfToken4;
